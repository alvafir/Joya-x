...
from modules.cache import (
    ...
    cached_recent_team, cached_h2h_safe, cached_recent_statistics_batch
)
...
st.markdown("<h1 class='joya-title'>💎 JOYA Enterprise 5.1 · Corner PRO DEV</h1>", unsafe_allow_html=True)
st.caption("Intelligence Hub · Projection Engine 3.0 · Corner Engine PRO")
...
if st.button("🧠 Ejecutar análisis JOYA 5.1",type="primary",use_container_width=True):
    raw = selected["raw"]
