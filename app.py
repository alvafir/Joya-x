...
from modules.cache import (
    ...
    cached_recent_team, cached_h2h_safe
)
...
st.markdown("<h1 class='joya-title'>💎 JOYA Enterprise 5.0 · Sprint 1 DEV</h1>", unsafe_allow_html=True)
st.caption("Intelligence Hub · Projection Engine 3.0 · Learning Engine")
...
if st.button("🧠 Ejecutar análisis JOYA 5.0",type="primary",use_container_width=True):
    raw = selected["raw"]
