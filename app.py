...
st.markdown("<h1 class='joya-title'>💎 JOYA Enterprise 5.4.1 · API Client Fix</h1>", unsafe_allow_html=True)
...
if st.button("🧠 Ejecutar análisis JOYA 5.4.1",type="primary",use_container_width=True):
    raw = selected["raw"]
